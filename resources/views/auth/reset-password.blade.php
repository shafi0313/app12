        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body p-5">
                ...
                <x-forms.form action="{{ route('password.update') }}">
                    ...
                    <x-forms.input type="password" name="password" label="password *" placeholder="Enter your password" required />
                    <x-forms.input type="password" name="password_confirmation" label="password confirmation *" placeholder="Enter your password" required />
                    <div class="d-grid">
